...
/* registers a previously registered interrupt handler
 * returns 0 on success, or -1 if there is no registered
 * interrupt handler of the specified type
 */
