/*
 * multilevel_queue.h - defines the interface of our multilevel queue ADT
...
/*
 * multilevel_queue_t is defined to be a pointer type which points to a
 * a struct multilevel_queue structure. the definition of this structure
 ...
 */
extern multilevel_queue_t multilevel_queue_new(int num_levels, multilevel_queue_order_t order);
 ...
 */
extern int multilevel_queue_enqueue(multilevel_queue_t obj, int level, any_t item);
 ...
 */
extern int multilevel_queue_dequeue(multilevel_queue_t obj, int level, any_t* item_p);
 ...
 * empty.
 */
extern int multilevel_queue_peak(multilevel_queue_t obj, int level, any_t* item_p);
 ...
 */
extern int multilevel_queue_iterate(multilevel_queue_t obj, PFany iter_func, any_t item);
 ...
 */
extern int multilevel_queue_free(multilevel_queue_t obj);
 ...
 * Otherwise, return -1 (failure).
 */
extern int multilevel_queue_length(multilevel_queue_t obj);
 ...
 * Otherwise, return -1 (failure)
 */
extern int multilevel_queue_delete(multilevel_queue_t obj, any_t item);
